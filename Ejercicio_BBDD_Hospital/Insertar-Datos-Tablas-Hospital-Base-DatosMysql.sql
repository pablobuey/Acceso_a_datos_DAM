...
VALUES(7369,'SANCHEZ','EMPLEADO',7902,'1980-11-02 00:00:00',10400,0,20);
INSERT INTO Emp( Emp_No, Apellido, Oficio, Dir, Fecha_Alt, Salario, Comision, Dept_No)
VALUES(7499,'ARROYO','VENDEDOR',7698,'1981-02-22 00:00:00',208000,39000,30);
INSERT INTO Emp( Emp_No, Apellido, Oficio, Dir, Fecha_Alt, Salario, Comision, Dept_No)
VALUES(7521,'SALA','VENDEDOR',689,'1981-02-22 00:00:00',162500,65000,30);
INSERT INTO Emp( Emp_No, Apellido, Oficio, Dir, Fecha_Alt, Salario, Comision, Dept_No)
VALUES(7566,'JIMENEZ','DIRECTOR',7839,'1981-04-02 00:00:00',386750,0,20);
INSERT INTO Emp( Emp_No, Apellido, Oficio, Dir, Fecha_Alt, Salario, Comision, Dept_No)
VALUES(7654,'MARTIN','VENDEDOR',7698,'1981-09-28 00:00:00',182000,182000,30);
INSERT INTO Emp( Emp_No, Apellido, Oficio, Dir, Fecha_Alt, Salario, Comision, Dept_No)
VALUES(7698,'NEGRO','DIRECTOR',7839,'1981-05-01 00:00:00',370500,0,30);
INSERT INTO Emp( Emp_No, Apellido, Oficio, Dir, Fecha_Alt, Salario, Comision, Dept_No)
VALUES(7782,'CEREZO','DIRECTOR',7839,'1981-06-09 00:00:00',318500,0,10);
INSERT INTO Emp( Emp_No, Apellido, Oficio, Dir, Fecha_Alt, Salario, Comision, Dept_No)
VALUES(7788,'NINO','ANALISTA',7566,'1987-03-30 00:00:00',390000,0,20);
INSERT INTO Emp( Emp_No, Apellido, Oficio, Dir, Fecha_Alt, Salario, Comision, Dept_No)
VALUES(7839,'REY','PRESIDENTE',0,'1981-11-17 00:00:00',650000,0,10);
INSERT INTO Emp( Emp_No, Apellido, Oficio, Dir, Fecha_Alt, Salario, Comision, Dept_No)
VALUES(7844,'TOVAR','VENDEDOR',7698,'1981-09-08 00:00:00',195000,0,30);
INSERT INTO Emp( Emp_No, Apellido, Oficio, Dir, Fecha_Alt, Salario, Comision, Dept_No)
VALUES(7876,'ALONSO','EMPLEADO',7788,'1987-05-03 00:00:00',143000,0,20);
INSERT INTO Emp( Emp_No, Apellido, Oficio, Dir, Fecha_Alt, Salario, Comision, Dept_No)
VALUES(7900,'JIMENO','EMPLEADO',7698,'1981-12-03 00:00:00',123500,0,30);
INSERT INTO Emp( Emp_No, Apellido, Oficio, Dir, Fecha_Alt, Salario, Comision, Dept_No)
VALUES(7902,'FERNANDEZ','ANALISTA',7566,'1981-12-03 00:00:00',390000,0,20);
INSERT INTO Emp( Emp_No, Apellido, Oficio, Dir, Fecha_Alt, Salario, Comision, Dept_No)
VALUES(7934,'MUÑOZ','EMPLEADO',7782,'1982-06-23 00:00:00',169000,0,10);
INSERT INTO Emp( Emp_No, Apellido, Oficio, Dir, Fecha_Alt, Salario, Comision, Dept_No)
VALUES(7119,'SERRA','DIRECTOR',7839,'1983-11-11 00:00:00',225000,39000,20);
INSERT INTO Emp( Emp_No, Apellido, Oficio, Dir, Fecha_Alt, Salario, Comision, Dept_No)
VALUES(7322,'GARCIA','EMPLEADO',7119,'1982-10-12 00:00:00',129000,0,20);
...
INSERT INTO Enfermo(Inscripcion,Apellido,Direccion,Fecha_Nac,S,NSS)
VALUES(14024,'Fernández M.','Recoletos 50','21-may-60','F',284991452);
INSERT INTO Enfermo(Inscripcion,Apellido,Direccion,Fecha_Nac,S,NSS)
VALUES(18004,'Serrano V.','Alcalá 12','23-jun-67','F',321790059);
INSERT INTO Enfermo(Inscripcion,Apellido,Direccion,Fecha_Nac,S,NSS)
VALUES(36658,'Domin S.','Mayor 71','01-ene-42','M',160654471);
INSERT INTO Enfermo(Inscripcion,Apellido,Direccion,Fecha_Nac,S,NSS)
VALUES(38702,'Neal R.','Orense 11','18-jun-40','F',380010217);
INSERT INTO Enfermo(Inscripcion,Apellido,Direccion,Fecha_Nac,S,NSS)
VALUES(39217,'Cervantes M.','Perón 38','29-feb-52','M',440294390);
INSERT INTO Enfermo(Inscripcion,Apellido,Direccion,Fecha_Nac,S,NSS)
VALUES(59076,'Miller B.','López de Hoyos 2','16-sep-45','F',311969044);
INSERT INTO Enfermo(Inscripcion,Apellido,Direccion,Fecha_Nac,S,NSS)
VALUES(63827,'Ruiz P.','Ezquerdo 103','26-dic-80','M',100973253);
INSERT INTO Enfermo(Inscripcion,Apellido,Direccion,Fecha_Nac,S,NSS)
VALUES(64823,'Fraiser A.','Soto 3','10-jul-80','F',285201776);
INSERT INTO Enfermo(Inscripcion,Apellido,Direccion,Fecha_Nac,S,NSS)
VALUES(74835,'Benítez E.','Argentina','05-oct-57','M',154811767);
